...
SpriteMorph.prototype.blockTemplates = function (category) {
    ...
    if (cat === 'motion') {
        ...
        blocks.push(watcherToggle('xAcceleration'));
        ...
        blocks.push(block('setYNetForce'));
        blocks.push(block('changeNetForce'));
        blocks.push(block('changeXNetForce'));
        blocks.push(block('changeYNetForce'));
        blocks.push(watcherToggle('xNetForce'));
    ...
    palette.userMenu = function () {
        ...
        function hasHiddenPrimitives() {
            var blocks = SpriteMorph.prototype.blocks,
                hiddenPrimitives = StageMorph.prototype.hiddenPrimitives;
            return Object.keys(hiddenPrimitives).some(function (any) {
                return !isNil(blocks[any]) && (blocks[any].category === category
        ...
        if (hasHiddenPrimitives()) {
            menu.addItem(
                'show primitives',
                function () {
                    var hiddenPrimitives = StageMorph.prototype.hiddenPrimitives,
                        blocks = SpriteMorph.prototype.blocks;
                    Object.keys(hiddenPrimitives).forEach(function (sel) {
                        if (blocks[sel] && (blocks[sel].category === category)) {
                            delete hiddenPrimitives[sel];
                        }
                    });
                    (more[category] || []).forEach(function (sel) {
                        delete hiddenPrimitives[sel];
